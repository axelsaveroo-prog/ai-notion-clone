...
import { Home, CheckSquare, Sparkles, Calendar, User } from "lucide-react";
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
      <nav className="pointer-events-auto bg-[#161618]/95 backdrop-blur-md border border-[#27272a] rounded-full px-4 py-2.5 shadow-2xl flex items-center gap-3">
        ...
        {/* 3. Center AI Button */}
        <Link href="/#ai-command" className="p-3.5 rounded-full transition-all shadow-lg scale-110 bg-[#f97316] text-black font-bold hover:bg-orange-600" title="AI Assistant">
        ...
        {/* 5. User & Sign In */}
        <Link href="/user" className={`p-2.5 rounded-full transition-all ${pathname === "/user" ? "bg-[#f97316] text-black shadow-md scale-105" : "text-gray-400 hover:text-white hover:bg-[#222226]"}`} title="User & Sign In">
